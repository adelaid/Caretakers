 ...
 * @author Ada
 */
@WebServlet(name = "AddPatientScheduleC", urlPatterns = {"/AddPatientScheduleC"})
public class AddPatientScheduleC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     Patient ct=(Patient)request.getSession().getAttribute("user");
     Long ctkid=ct.getId();
     
     //String startT="2017-03-21 10:15:00";
        addTimeReference(ctkid, data + " "+stime, data + " "+etime, true);
        request.getRequestDispatcher("AddNeedJSP.jsp").forward(request, response);
