<%-- 
    ...
    Created on : Mar 21, 2017, 7:28:41 PM
    Author     : Ada
--%>
...
<!--             <div id="bigmenulinks">
    ...
    <form class="well form-horizontal"  method="post" action="RegisterPatientC"  id="contact_form">
<fieldset>
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Street Number</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
        <input id="streetno" name="streetno" placeholder="Street Number" class="form-control"  type="text" required>
    </div>
  </div>
</div>
