 ...
 * @author Ada
 */
@WebServlet(name = "RegisterC", urlPatterns = {"/RegisterC"})
public class RegisterC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String mail = request.getParameter("mail");
        ...
        addCaretaker(firstName,lastName,mail,username,pass);
    ...
    private void addCaretaker(java.lang.String firstName, java.lang.String lastName, java.lang.String email, java.lang.String username, java.lang.String password) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        ws.CaretakerWS port = service.getCaretakerWSPort();
        port.addCaretaker(firstName, lastName, email, username, password);
    }
