 ...
 * 
 */
@WebServiceClient(name = "PatientWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/PatientWS/PatientWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PATIENTWS_QNAME = new QName("http://ws/", "PatientWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/PatientWS/PatientWS?wsdl");
    ...
    public PatientWS getPatientWSPort() {
        return super.getPort(new QName("http://ws/", "PatientWSPort"), PatientWS.class);
    }
    ...
    public PatientWS getPatientWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "PatientWSPort"), PatientWS.class, features);
    }
